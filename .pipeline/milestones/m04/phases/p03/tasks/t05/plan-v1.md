Now I have a complete picture. Let me produce the specification.
...
### EmptyState tests (`empty-state.test.tsx` — 10 tests)
| # | Test | Expected |
|---|------|----------|
...
### SearchInput tests (`search-input.test.tsx` — 14 tests)
| # | Test | Expected |
|---|------|----------|
